      ...
      <div className="flex-1 flex items-center justify-center px-4">
        <div className="w-full max-w-sm">
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-zinc-500">Sign in to manage your dependency updates</p>
          </div>
          ...
          <div className="border border-zinc-200 rounded-xl p-6 bg-white shadow-sm">
            ...
            <p className="text-xs text-zinc-400 text-center mt-4">
              By signing in you agree to let Patchboard read your repositories to scan dependencies.
            </p>
          </div>
