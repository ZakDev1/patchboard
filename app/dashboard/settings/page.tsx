...
export default async function SettingsPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-10">
      ...
      <p className="text-sm text-zinc-500 mb-8">Manage your account and billing</p>
      ...
      <section className="mb-8">
        ...
        <div className="border border-zinc-200 rounded-xl p-4 flex items-center gap-4">
          <Avatar className="h-10 w-10">
            ...
            <AvatarFallback className="text-sm">{username?.[0]?.toUpperCase() ?? "U"}</AvatarFallback>
          </Avatar>
        ...
        {plan === "pro" ? (
          <div className="border border-zinc-200 rounded-xl overflow-hidden">
            <div className="p-4 flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-zinc-900">Patchboard Pro</p>
                <p className="text-xs text-zinc-500 mt-0.5">Active subscription</p>
              </div>
            ...
            <div className="p-4">
              ...
              <form action={createPortalSession}>
                <Button type="submit" variant="outline" size="sm" className="h-8 text-xs text-zinc-600">
                  Manage subscription
                </Button>
              </form>
              <p className="text-xs text-zinc-400 mt-2">Cancel or change your plan via the billing portal.</p>
            </div>
          </div>
        ) : (
          <div className="border border-zinc-200 rounded-xl overflow-hidden">
            <div className="p-4">
              ...
              <p className="text-xs text-zinc-500 mt-0.5">You&apos;re on the free tier.</p>
            </div>
            <Separator />
            <div className="p-4">
