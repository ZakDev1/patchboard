...
export const docs = await create.docs("docs", "content/docs", {"meta.json": __fd_glob_0, }, {"changelog.mdx": __fd_glob_1, "getting-started.mdx": __fd_glob_2, "how-it-works.mdx": __fd_glob_3, "index.mdx": __fd_glob_4, });